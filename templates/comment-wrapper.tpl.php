...
?>
<section class="comments <?php print $classes; ?>"<?php print $attributes; ?> id="comments">
  <?php print render($title_prefix); ?>
  <?php if ($comments && $node->type != 'forum'): ?>
    <h2 class="comments__title"><?php print t('Comments'); ?></h2>
  <?php endif; ?>
  ...
  <?php if ($comment_form): ?>
    <h2 class="comments__form-title"><?php print t('Add new comment'); ?></h2>
